  ...
  return (
    <>
      ...
      <div className="flex gap-4 pb-20 pt-10">
        <a
          href="#projects"
          className="px-4 py-2 border-2 border-[#AC0022] transition-opacity hover:bg-[#AC0022] hover:text-[#F9F3ED] rounded-2xl w-fit h-fit text-base text-black transition-all duration-300 md:text-sm lg:text-sm"
        >
          View Projects
        </a>
        <a
