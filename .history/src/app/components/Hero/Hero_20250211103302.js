  ...
  return (
    <>
      ...
      <div className="flex gap-4 pb-20 pt-10">
        ...
        <iframe style="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/design/cONVb0kTlMWcbc6h87uAMQ/Aether-Prototype-(Copy)?node-id=49-10&embed-host=share" allowFullScreen></iframe>
      </div>
    </>
  );
}
