  ...
  return (
    <>
      ...
      <div className="flex gap-4 pb-20">
        <a
          href="#projects"
          className="px-3 py-3 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-opacity bg-[#AC0022] rounded-2xl w-fit px-4 py-2 text-base text-[#F9F3ED] underline md:text-sm"
        >
          View Projects
        </a>
        <a
