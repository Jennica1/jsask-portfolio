  ...
  return (
    <>
      ...
      <div className="flex gap-4 pb-20">
        <a
          href="#projects"
          className="px-3 py-3 hover:opacity-90 transition-opacity bg-[#AC0022] rounded-2xl w-fit h-fit text-base text-[#F9F3ED] underline md:text-sm lg:text-sm"
        >
          View Projects
        </a>
        <a
          href="#contact"
          className="px-2 py-3 hover:opacity-90 transition-opacity bg-[#AC0022] rounded-2xl w-fit h-fit text-base text-[#F9F3ED] underline md:text-sm lg:text-sm"
        >
          Contact Me
        </a>
      </div>
