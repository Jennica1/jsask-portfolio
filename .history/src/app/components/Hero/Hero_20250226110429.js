...
export default function Hero() {
  return (
    <>
      <div id="about" className="flex flex-col items-center px-8 pt-48 py-3 space-y-2 ">
        <h1 className="text-5xl md:text-4xl font-bold">Jennica Sask</h1>
        <p className="text-md mb-8 justify-center align-center">
