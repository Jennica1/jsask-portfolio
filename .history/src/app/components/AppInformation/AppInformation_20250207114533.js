        ...
        <div className="text-sm lg:pt-10 sm:w-2/3 md:w-3/4 md:text-xs">
          <span className="inline-flex items-baseline pb-1">
            ...
            <Link
              ...
              className="bg-[#AC0022] rounded w-fit px-2 py-1 text-base text-[#F9F3ED] underline md:text-sm"
            >
             Click
            </Link>
          </span>
          ...
          <div className="mt-4">
            ...
            <p className="text-base md:text-sm">{role}</p>
          </div>
          ...
          <div className="mt-4">
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {skills.map((skill, index) => (
                <span
                  key={index}
                  className="bg-[#2C304F] px-3 py-2 rounded text-base md:text-sm text-[#F9F3ED]"
                >
                  {skill}
                </span>
              ))}
