...
export default function AppInformation({ appName, appLink, role, skills, description, status }) {
  return (
    <section className="flex justify-center">
      <div className="flex flex-wrap sm:flex-col sm:space-y-6 justify-center w-full max-w-4xl gap-x-10">
        {/* Left Section */}
        <div className="w-1/2 sm:w-full px-4 text-sm lg:pt-10 md:text-xs">
