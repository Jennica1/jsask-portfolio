        ...
        <div className="text-sm lg:pt-10 md:text-xs max-w-fit">
          <span className="inline-flex items-baseline pb-1">
            ...
            <Link
              ...
              className="bg-[#AC0022] rounded-2xl w-fit px-3 py-1.5 text-base text-[#F9F3ED] underline md:text-sm"
            >
              Click
            </Link>
          </span>

          <p className="bg-[#2C304F] mt-2 rounded w-fit px-3 py-1 text-base md:text-sm text-[#F9F3ED]">
            {status}
          </p>
