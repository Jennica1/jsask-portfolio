    ...
    <section className="w-full py-16 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center space-y-6">
          ...
          <a
            href={`mailto:${email}`}
            className=" group inline-flex items-center gap-2 px-6 py-3 rounded-full transition-all  px-4 py-2 border-2 border-[#890620] hover:bg-[#890620] hover:text-[#F9F3ED] transition-all duration-300  "
          >
