    ...
    <>
      <div id="contact" className="max-w-2xl w-full p-6 bg-white rounded-lg mb-20">
        ...
        <div className="flex flex-col gap-2 mt-8">
          ...
          <a
            href={`mailto:${email}`}
            className="group inline-flex items-center gap-2 px-6 py-3 rounded-full border border-[#890620] hover:bg-[#890620] hover:text-[#F9F3ED] transition-all duration-300 border-2 lg:w-[28%] md:w-[30%]"
          >
