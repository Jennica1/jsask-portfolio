          ...
          <section className="flex flex-row justify-center gap-6 w-full max-w-6xl mx-auto pt-5">
            <div className="flex-1 max-w-fit">
              ...
              <p className="max-w-xl">
                Breezy Bee’s Hydromel is a Canadian-owned meadery focused on all natural, locally sourced ingredients that’s packed full of fruity flavours. Targeted towards those who want to support their local Canadian beekeepers and care about authentic natural ingredients.
              </p>
            </div>
          </section>
