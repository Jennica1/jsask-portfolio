...
export default function FloatingShapes() {
  ...
  useEffect(() => {
    ...
    sceneRef.current.addEventListener("mousedown", () => {
      Matter.Body.setVelocity(floatingTriangle, { x: 2, y: -2 });
    });
  ...
  return (
    <>
<main className="flex justify-center flex-col items-center opacity-0 animate-fadeIn animate-slideIn relative pointer-events-none">
...
<div ref={sceneRef} className="fixed top-0 left-0 w-full h-full -z-10 pointer-events-auto">
  <Image
    ref={triangleRef}
