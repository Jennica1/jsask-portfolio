          ...
          <section className="mt-20">
            <div className="flex flex-col">
              ...
              <div className=" pt-6 md:pt-24 md:text-left">
                ...
                <hr className="border-black border-2 lg:w-[70%] "></hr>
                <p className="text-left pt-2 max-w-6xl pb-6">
...
<span>
<h2 className="md:mt-3 text-xl font-bold pb-2">Aether Landing Page:</h2>
<Link href="https://aether-landing-page.vercel.app/"/>
</span>
          ...
          <div>
          <h2 className=" text-xl font-bold pb-2 pt-8" >My Business Card!</h2>
            <Image src="/aether/Aether Business Card.png"
            width={0}
            height={0}
