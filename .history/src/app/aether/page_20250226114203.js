      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section className="mt-44">
          <div>
            ...
            <p className="pt-2 pb-4">Based on survey results as well as online research two main user personas were created:</p>
            ...
            <p>By narrowing down Aether’s user personas, the ability to fine-tune the needs of caregivers is much easier now. </p>
