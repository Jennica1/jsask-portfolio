  ...
  return (
    <>
      <section className="mt-44">
        ...
        <ul style={{ listStyleImage: "url('.//images/exclam.svg')", }} className="flex flex-col lg:ml-14 ml-6 mb-10 text-[#890620]  list-disc lg:gap-2 lg:text-2xl md:text-xl">
