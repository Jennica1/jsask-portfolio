    ...
    <div className="flex justify-center flex-col items-center">
      ...
      <main className="lg:px-24 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section>
          ...
          <p w-12>Aether is a form-filling app designed to alleviate stress for caregivers. It streamlines the document-filling process by simplifying complex paperwork, saving time through its auto-fill capabilities, and makes the form-filling process hassle-free.</p>
        </section>
