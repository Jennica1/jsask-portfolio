  ...
  return (
    <>
      <section className="mt-44">
        ...
        <p className="max-w-xl mb-4 md:w-[70%]">
        ...
        <ul style={{listStyleImage: "url('.//images/exclam.svg')" }} className="flex flex-col ml-6 mb-10 text-[#890620] underline list-disc lg:gap-2 lg:text-2xl md:text-xl">
