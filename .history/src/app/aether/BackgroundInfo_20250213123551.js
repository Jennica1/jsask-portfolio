  ...
  return (
    <>
      <section className="mt-44">
        ...
        <ul style={{listStyleImage: "url('.//images/exclam.svg')", margin:'20px' }} className="flex flex-col ml-6 mb-10 text-[#890620] underline list-disc lg:gap-2 lg:text-xl md:text-xl">
