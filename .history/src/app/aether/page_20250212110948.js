      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section className="mt-44">
          ...
          <p className="max-w-full mb-4 ">
            Our survey sought to understand the diverse experiences of
            caregivers when managing forms for elderly individuals. To enhance
            the Aether app’s usability and effectiveness, we recommend
            incorporating the following innovative strategies:
          </p>
          <div className="p-6 bg-[#625D9C] rounded-3xl">
            <div className="flex flex-row space-x-8 text-[#F9F3ED]">
              <div className="flex flex-col">
                <h2 className="md:mt-3 text-xl font-bold">
          ...
          <div className="flex flex-row align-center ">
            <div className="w-1/3 pt-24 mr-[20%]">
              ...
              <p className="w-auto">
                ...
                simplifying complex paperwork, saving time through its auto-fill
                capabilities, and makes the form-filling process hassle-free.
              </p>
            </div>
            <Image
