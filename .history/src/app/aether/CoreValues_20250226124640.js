...
export default function CoreValues() {
  ...
  return (
    <section className="mt-44 max-w-5xl flex justify-center place-self-center place-content-center content-center place-items-center">
       <h2 className="md:mt-3 text-3xl font-bold">Core Features:</h2>
       <hr className="border-black border-2 lg:w-[70%] "></hr>
      <div className="flex items-center pt-32 w-full ">
