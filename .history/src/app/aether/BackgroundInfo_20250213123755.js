  ...
  return (
    <>
      <section className="mt-44">
        ...
        <ul style={{listStyleImage: "url('.//images/exclam.svg')", }} className="flex flex-col ml-6 mb-10 text-[#890620] underline list-disc lg:gap-2 lg:text-xl md:text-xl">
        ...
        <div className="">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-[#F9F3ED]">
            {/* Top-Left */}
            <ul className="flex flex-col space-y-2 p-6 bg-[#625D9C] rounded-3xl">
              <li style={{listStyleImage: "url('.//images/exclam.svg')", }} className="text-xl font-bold">
