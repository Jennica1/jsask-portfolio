          ...
          <section className="mt-20">
            <div className="flex flex-col md:flex-row gap-6 items-start">
              <div className="flex flex-col md:flex-row gap-6 w-full max-w-6xl">
                <div className="w-[8px] bg-[#890620] md:h-auto"></div>
                {/* Main Content */}
                <div className="flex-1 max-w-full">
                  ...
                  <ul className="list-disc ml-6 mb-6 mt-6 font-bold text-lg  space-y-4">
                    <li>
              ...
              <Image
                ...
                className="w-full md:w-80 h-auto mt-6 md:mt-0"
              />
            </div>
          </section>
