        ...
        <section className="mt-44">
          <div>
            ...
            <ul className="lg:list-disc lg:text-base lg:ml-12 lg:pb-4 text-xs ">
              <li className="font-bold">Sarah Jones works as a full-time caregiver.</li>
              <li className="font-bold">Ken Lee works full-time and cares for his mother.</li>
            </ul>
          ...
          <section className="mt-20">
            <div className="flex flex-col md:flex-row  gap-6 md:gap-12">
              <div className="flex flex-row md:flex-row gap-6 w-full max-w-xl ">
                ...
                <h2 className="md:mt-3 text-3xl font-bold">The Solution:</h2>
                <hr className="border-black border-2 lg:w-[70%] "></hr>
