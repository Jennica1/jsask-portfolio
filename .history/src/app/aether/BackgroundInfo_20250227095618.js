  ...
  return (
    <>
      <section className="mt-44">
        ...
        <p className="text-2xl font-bold">Survey Found:</p>
        ...
        <div className="">
    <p className="text-xl font-bold pb-2 ">Taking their pain-points into consideration, the following recommendations was found:</p>
