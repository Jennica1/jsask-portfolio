  ...
  return (
    <div className="flex justify-center flex-col items-center">
      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <AppInformation
          appName="Aether"
          appLink={["https://www.figma.com/proto/cONVb0kTlMWcbc6h87uAMQ/Aether-Prototype-(Copy)?page-id=2750%3A6683&node-id=2751-16880&p=f&viewport=410%2C424%2C0.03&t=0LSxHP6hTHazRigC-1&scaling=scale-down&content-scaling=fixed&starting-point-node-id=2750%3A7345&show-proto-sidebar=1", "https://aether-landing-page.vercel.app/"]}
          role="Developer"
...
<div flex flex-col space-y-2 p-6 bg-[#625D9C] rounded-3xl>
                <h2 className="text-xl font-bold">
        ...
        <section className="mt-44">
          ...
          <section className="mt-20">
            <div className="flex flex-col md:flex-row items-center md:items-start md:space-x-8">
              {/* Text Section */}
              <div className="w-full md:w-1/2 pt-6 md:pt-24 md:mr-[20%] md:text-left">
