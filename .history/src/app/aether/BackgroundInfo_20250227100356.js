        ...
        <div className="">
          ...
          <div className="">
            ...
            <div className="flex flex-col space-y-2 p-6 ">
              ...
              <p className="">
                Implement an AI that will help users who are unsure of how to
                fill out a form. Allow users to ask questions and have feedback
                on questions they are unsure about to ensure the form is filled
                out correctly.
              </p>
            </div>
          </div>
