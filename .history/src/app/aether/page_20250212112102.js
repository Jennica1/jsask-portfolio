...
export default function Aether() {
    ...
    <div className="flex justify-center flex-col items-center">
      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section className="mt-44">
          ...
          <p className="max-w-full mb-4 w-70%">
  ...
  <div className="flex flex-col md:flex-row md:space-x-8 space-y-6 md:space-y-0 text-[#F9F3ED]">
    ...
    <div className="flex flex-col space-y-2">
      <h2 className="text-xl font-bold">Simplify Form-filling Process</h2>
      ...
      <h2 className="text-xl font-bold">Improve App Navigation and Usability</h2>
      <p className="max-w-xl pb-4">
    ...
    {/* Second Column */}
    <div className="flex flex-col space-y-2">
      <h2 className="text-xl font-bold">Develop Time-saving Features</h2>
      <p className="max-w-xl pb-4">
