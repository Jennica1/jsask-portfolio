      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section className="mt-44">
          <div>
            ...
            <p className="pt-2 pb-2">Based on survey results as well as online research two main user personas were created:</p>
            ...
            <p className="hidden text-xs pt-2">By narrowing down Aether’s user personas, the ability to fine-tune the needs of caregivers is much easier now. </p>
            ...
            <div className="block md:hidden">
              <Slideshow
                ...
                width="w-100"
              />
               <p className="text-xs pt-2">By narrowing down Aether’s user personas, the ability to fine-tune the needs of caregivers is much easier now. </p>
            </div>
          </div>
          ...
          <section className="mt-20">
            <div className="flex flex-col">
              {/* Text Section */}
              <div className="w-full  pt-6 md:pt-24 md:mr-[20%] md:text-left">
                <h2 className="text-3xl font-bold">Competitive Analysis:</h2>
                <hr className="border-black border-2 lg:w-[70%] "></hr>
                <p className="text-left pt-2 max-w-4xl">
          ...
          <section className="mt-44">
            ...
            <hr className="border-black border-2 lg:w-[70%] "></hr>
            <h2 className="md:mt-3 text-xl font-bold pt-2">User Flow</h2>
            <Image
