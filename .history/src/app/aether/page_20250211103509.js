      ...
      <main className="lg:px-40 p-5 opacity-0 animate-fadeIn animate-slideIn">
        ...
        <section className="mt-44 ">
          ...
          <div className="mt-44">
            ...
            <iframe className="border: 1px solid rgba(0, 0, 0, 0.1);" width="800" height="450" src="https://embed.figma.com/design/cONVb0kTlMWcbc6h87uAMQ/Aether-Prototype-(Copy)?node-id=49-10&embed-host=share" allowFullScreen></iframe>
          </div>
        </section>
