  ...
  return (
    <>
      <section className="mt-44">
        ...
        Aether conducted 2 rounds of interviews, 1 for the initial idea which was more focused on an older demographic looking for a solution to easily file forms while the second was more centered around understanding the diverse experiences caretakers and individuals who would be responsible for filling out forms for seniors feel while carrying out their tasks. 
        </p>

        <p className="text-2xl font-bold pb-2">Survey Found:</p>

        <ul style={{ listStyleImage: "url('.//images/exclam.svg')", }} className="flex flex-col lg:ml-14 ml-6 mb-10 text-[#890620]  list-disc lg:gap-2 lg:text-xl md:text-xl">
        ...
        <div className="">
        <p className="text-2xl font-bold pb-2">As a result, the following recommendations was suggested:</p>
          <div className="">
            {/* Top-Left */}
            <div className="flex flex-col space-y-2 p-6  rounded-tr-none rounded-bl-none rounded-3xl">
            ...
            {/* Top-Right */}
            <div className="flex flex-col space-y-2 p-6  rounded-tl-none rounded-br-none rounded-3xl">
              <ul className="list-none pl-0">
            ...
            {/* Bottom-Right */}
            <div className="flex flex-col space-y-2 p-6 rounded-3xl">
              <ul className="list-none pl-0">
              <li className="text-xl font-bold flex items-center pl-8"
                  style={{
                    backgroundImage: "url('/images/star.svg')",
