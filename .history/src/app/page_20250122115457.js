    ...
    <div className="flex justify-center flex-col items-center">
      ...
      <main>
        ...
        <p>
          ...
          issue and a way to provide a solution to it. The issue was endangered
          animals and the solution was to educate those at an early age to
          develop an early understanding on what they can do to help.
        </p>
        <section></section>
