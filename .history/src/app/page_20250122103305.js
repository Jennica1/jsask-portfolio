      ...
      <main>
        <section className="relative">
          ...
          <div className="relative flex flex-col md:flex-row items-start gap-8 p-8 ">
            ...
            {/* App Details */}
            <div className="text-sm sm:text-base md:text-lg lg:text-xl lg:pt-10 sm:w-3/4 md:w-2/3 lg:w-1/2">
  <h2 className="text-lg sm:text-xl md:text-xl lg:text-3xl font-bold">
    Pocket Pals
  </h2>
