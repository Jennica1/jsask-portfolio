...
export default function AppInformation() {
  return (
    <>
      <section className="relative lg:mr-40 lg:ml-40 lg:mb-40 md:mb-5 ">
        {/* Background Image */}
        <Image
  ...
  <span className="inline-flex items-baseline">
    ...
    <Link
      ...
      className="text-blue-600 underline pl-3 md:text-sm"
    >
      Visit App
    </Link>
  </span>

  <p className="bg-gray-100 rounded w-fit px-3 py-2 text-base md:text-sm">UI/UX</p>

  <p className="mt-4 md:mt-1 text-base md:text-sm w-[90%]">
    A learning app for kids. Focused on educating children about endangered animals across the globe through interactive learning.
  </p>

  <h2 className="mt-6 md:mt-2 text-xl font-bold md:text-lg">Project Details:</h2>
  ...
  <div className="mt-4">
    ...
    <div className="flex flex-wrap gap-2 mt-2">
      <span className="bg-gray-100 px-3 py-2 rounded text-base md:text-sm">
        Figma
      </span>
      <span className="bg-gray-100 px-3 py-2 rounded text-base md:text-sm">
        Next.js
