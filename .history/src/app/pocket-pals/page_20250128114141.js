...
export default function pocketPals() {
      ...
      <main className="lg:p-20 p-5 ">
        ...
        <section className="relative flex flex-col md:flex-row items-start mb-10">
          ...
          <div className="flex md:hidden w-full flex-col">
            ...
            <Slideshow
              slides={[
                { image: "/pocketPals/MidFi - Choose Your Region.png", alt: "Slide 1" },
                {
  ...
  {/* Images for larger screens */}
  <div className="w-full">
    <label className="block text-lg font-semibold mb-3">LoFi Design</label>
    <div className="hidden md:flex gap-4 items-center -mt-3">
      <Image
        src="/pocketPals/LoFi - Leading Page.png"
        width={0}
        height={0}
        className="w-1/4 lg:w-1/5 h-auto"
        alt="HiFi - Home Page"
      />
      <Image
      ...
      <Slideshow
        slides={[
          { image: "./pocketPals/LoFi - Rough Sketch.png", alt: "Slide 1" },
  ...
  <div className="flex md:hidden w-full flex-col">
    <Slideshow
      slides={[
        { image: "./pocketPals/LoFi - Leading Page.png", alt: "Slide 1" },
