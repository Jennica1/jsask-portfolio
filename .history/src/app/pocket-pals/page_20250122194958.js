    ...
    <div className="flex justify-center flex-col items-center">
      ...
      <main className="p-5">
        ...
        <section className="relative flex flex-col md:flex-row items-start ">
          ...
          <ol>
            <ul>Final UI design had no error in user testers navigating the app
</ul>
            <ul>Colours chosen were bright yet, complimented each other
            </ul>
            <ul>
            Reduced word count of information and increased text size for better reading
            </ul>
          </ol>
        </section>
      </main>
