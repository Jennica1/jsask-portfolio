...
export default function AppInformation() {
  return (
    <>
        <section className="relative lg:mb-40 md:mb-5 lg:min-h-[80vh] xl:min-h-[90vh]">
  {/* Background Image */}
  <Image
  ...
  {/* Foreground Content */}
  <div className="relative flex flex-col md:flex-row items-start gap-8 p-8 lg:p-16 xl:px-24 max-w-7xl mx-auto">
    {/* App Title Image */}
    <Image
      ...
      height={0}
      alt="Pocket Pals"
      className="w-[80%] sm:w-[70%] md:w-[60%] lg:w-[40%] max-w-[800px] object-contain mx-auto md:mx-0"
    />
    ...
    <div className="text-sm lg:pt-10 sm:w-2/3">
      ...
      <h2 className="mt-6 md:mt-1 text-xl font-bold">Project Details:</h2>
      <div className="mt-4">
      ...
      <div className="mt-4">
        ...
        <div className="flex flex-wrap gap-2 mt-2">
          <span className="bg-gray-100 px-3 py-2 rounded text-base">Figma</span>
          <span className="bg-gray-100 px-3 py-2 rounded text-base">Next.js</span>
