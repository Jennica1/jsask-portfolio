...
export default function Information() {
  return (
    <>
      <section className="flex flex-row justify-center gap-6 w-full max-w-2xl mx-auto pt-10 mt-20">
        {/* Left Box */}
        ...
        <div className="flex-1 max-w-fit">
          ...
          <ul className="list-disc ml-6 mb-6">
            ...
            <li>
              Colours that elementary-aged children engage
              positively with.
            </li>
            <li>
              Games that are basic for children but makes learning more
              engaging.
            </li>
          </ul>
