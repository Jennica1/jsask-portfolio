    ...
    <>
      <section className="flex flex-row justify-center gap-6 w-full max-w-6xl mx-auto pt-10 mt-20">
        ...
        <div className="flex-1 max-w-fit">
          ...
          <p className="max-w-xl">
            Colour choices were bright but, visually unappealing and frequently
            clashed together. Balancing the amount of article information that
            is informative but can still be understood by young children.
          </p>
        </div>
      </section>
    </>
