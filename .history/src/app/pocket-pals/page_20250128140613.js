  ...
  return (
    <div className="flex justify-center flex-col items-center">
      ...
      <main className="lg:p-10 p-5 ">
        ...
        <section className="relative flex flex-col items-center justify-center w-full max-w-screen-md  px-4">
          {/* Images for larger screens */}
          <div className="w-full">
            <label className="block text-lg font-semibold mb-3">
              LoFi Design
            ...
            <div className="hidden md:flex gap-4 items-center -mt-3 ">
              <Image
                ...
                width={0}
                height={0}
                className="lg:w-80 h-auto md:w-auto"
                alt="HiFi - Home Page"
              />
              <Image
                ...
                width={0}
                height={0}
                className="w-80 h-auto md:w-auto"
                alt="HiFi - Marmot Article"
              />
              <Slideshow
                slides={[
