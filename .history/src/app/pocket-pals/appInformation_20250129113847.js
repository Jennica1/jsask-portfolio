    ...
    <>
      <section className="relative lg:mr-40 lg:ml-40 lg:mb-40 md:mb-5 ">
        ...
        <div className="relative flex flex-col md:flex-row items-start gap-8 p-8 ">
          ...
          {/* App Details */}
          <div className="text-sm lg:pt-10 sm:w-2/3 md:w-auto">
            <span className="inline-flex items-baseline ">
              ...
              <Link
                ...
                className="text-blue-600 underline pl-3"
              >
                Visit App
              </Link>
            </span>

            <p className="bg-gray-100 rounded text-base w-fit px-3 py-2 ">UI/UX</p>
