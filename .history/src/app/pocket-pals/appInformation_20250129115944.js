      ...
      <section className="relative lg:mr-40 lg:ml-40 lg:mb-40 md:mb-5 lg:text-[#F9F3ED] md:text-[#F9F3ED]">
        ...
        <div className="relative flex flex-col md:flex-row items-start gap-8 p-8 ">
          ...
          <div className="text-sm lg:pt-10 sm:w-2/3 md:w-3/4 md:text-xs">
            ...
            <p className="bg-[#2C304F] rounded w-fit px-3 py-2 text-base md:text-sm">
              UI/UX
            </p>
            ...
            <div className="mt-4">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                <span className="bg-[#2C304F] px-3 py-2 rounded text-base md:text-sm">
                  Figma
                </span>
                <span className="bg-[#2C304F] px-3 py-2 rounded text-base md:text-sm">
                  Next.js
                </span>
                <span className="bg-[#2C304F] px-3 py-2 rounded text-base md:text-sm sm:text-[#F9F3ED]">
                  User Testing
                </span>
              </div>
            </div>
