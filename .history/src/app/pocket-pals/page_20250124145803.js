...
export default function pocketPals() {
  ...
  <Image
    ...
    height={0}
    alt="Background Image"
    className="absolute inset-0 w-full h-full object-cover -z-10" // Ensures the image is behind content
  />

  {/* Content */}
  <div className="relative z-20 p-6 md:p-10 bg-opacity-90 backdrop-blur-sm bg-white rounded-lg shadow-lg w-full">
    <h2 className="mt-6 md:mt-3 text-xl font-bold">
