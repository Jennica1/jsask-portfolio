    ...
    <div className="flex justify-center flex-col items-center">
      ...
      <main>
        <div className="relative">
          ...
          {/* Foreground Content */}
          <div className="relative flex flex-col md:flex-row items-start gap-8 p-8 scale-100">
            {/* App Title Image */}
            <Image
              ...
              height={0}
              alt="pocket pals"
              className="w-2/5 max-w-lg object-contain"
            />

            {/* App Details */}
            <div className="text-lg scale-100">
